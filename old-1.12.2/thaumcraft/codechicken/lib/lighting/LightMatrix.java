...
public class LightMatrix implements CCRenderState.IVertexOperation {
   ...
   public void sample(int i) {
      if ((this.sampled & 1 << i) == 0) {
         ...
         IBlockState b = this.access.func_180495_p(new BlockPos(x, y, z));
         this.bSamples[i] = this.access.func_175626_b(new BlockPos(x, y, z), b.func_177230_c().getLightValue(b, this.access, new BlockPos(x, y, z)));
         this.aSamples[i] = b.func_185892_j();
      }
