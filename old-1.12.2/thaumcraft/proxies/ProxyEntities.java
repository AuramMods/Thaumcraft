...
public class ProxyEntities {
   public void setupEntityRenderers() {
      ...
      RenderingRegistry.registerEntityRenderingHandler(EntityTaintSeedPrime.class, new RenderTaintSeed(Minecraft.func_71410_x().func_175598_ae(), new ModelTaintacle(12, false), 0.8F));
      ...
      RenderingRegistry.registerEntityRenderingHandler(EntityGenericProjectile.class, new RenderNoProjectile(Minecraft.func_71410_x().func_175598_ae()));
