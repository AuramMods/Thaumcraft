...
public class CardPortal extends TheorycraftCard {
   ...
   public String getLocalizedName() {
      return (new TextComponentTranslation("card.portal.name", new Object[0])).func_150254_d();
   }

   public String getLocalizedText() {
      return (new TextComponentTranslation("card.portal.text", new Object[0])).func_150254_d();
   }
   ...
   public boolean activate(EntityPlayer player, ResearchTableData data) {
      ...
      data.addTotal(s[player.func_70681_au().nextInt(s.length)], MathHelper.func_76136_a(player.func_70681_au(), 5, 10));
      data.addTotal("ELDRITCH", MathHelper.func_76136_a(player.func_70681_au(), 5, 10));
      data.bonusDraws += 2;
