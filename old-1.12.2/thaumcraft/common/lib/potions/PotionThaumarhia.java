...
public class PotionThaumarhia extends Potion {
   ...
   public void func_76394_a(EntityLivingBase target, int par2) {
      if (!target.field_70170_p.field_72995_K && target.field_70170_p.field_73012_v.nextInt(15) == 0 && target.field_70170_p.func_175623_d(new BlockPos(target))) {
         target.field_70170_p.func_175656_a(new BlockPos(target), BlocksTC.fluxGoo.func_176223_P());
      }
