...
public class PacketFXSlash implements IMessage, IMessageHandler<PacketFXSlash, IMessage> {
   ...
   public IMessage onMessage(PacketFXSlash message, MessageContext ctx) {
      ...
      if (var2 != null && var3 != null) {
         FXDispatcher.INSTANCE.drawSlash(var2.field_70165_t, var2.func_174813_aQ().field_72338_b + (double)(var2.field_70131_O / 2.0F), var2.field_70161_v, var3.field_70165_t, var3.func_174813_aQ().field_72338_b + (double)(var3.field_70131_O / 2.0F), var3.field_70161_v, 8);
      }
