...
public class ChampionModifier {
   ...
   public static AttributeModifier ATTRIBUTE_MOD_NONE = new AttributeModifier(UUID.fromString("1e645a3d-9115-4807-a61c-705172839f87"), "normal", 1.0D, 0);
   ...
   public ChampionModifier(int id, String name, int type, IChampionModifierEffect effect, UUID iud) {
      ...
      this.type = type;
      this.effect = effect;
      this.attributeMod = new AttributeModifier(iud, name, (double)(id + 2), 0);
   }

   public String getModNameLocalized() {
      return I18n.func_74838_a("champion.mod." + this.name);
   }
}
