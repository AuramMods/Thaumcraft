...
public class ChampionModPoison implements IChampionModifierEffect {
   ...
   public void showFX(EntityLivingBase boss) {
      if (!boss.field_70170_p.field_73012_v.nextBoolean()) {
         ...
         FXDispatcher.INSTANCE.drawGenericParticles(boss.func_174813_aQ().field_72340_a + (double)w, boss.func_174813_aQ().field_72338_b + (double)h, boss.func_174813_aQ().field_72339_c + (double)d, 0.0D, 0.02D, 0.0D, 0.2F, 0.6F + boss.field_70170_p.field_73012_v.nextFloat() * 0.1F, 0.2F + boss.field_70170_p.field_73012_v.nextFloat() * 0.1F, 0.7F, false, 147, 4, 1, 8 + boss.field_70170_p.field_73012_v.nextInt(4), 0, 0.5F + boss.field_70170_p.field_73012_v.nextFloat() * 0.2F, 0.5F, 0);
      }
   }
}
