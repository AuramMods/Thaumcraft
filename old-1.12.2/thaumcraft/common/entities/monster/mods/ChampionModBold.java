...
public class ChampionModBold implements IChampionModifierEffect {
   ...
   public void showFX(EntityLivingBase boss) {
      if (!boss.field_70170_p.field_73012_v.nextBoolean()) {
         ...
         FXDispatcher.INSTANCE.spark(boss.func_174813_aQ().field_72340_a + (double)w, boss.func_174813_aQ().field_72338_b + (double)h, boss.func_174813_aQ().field_72339_c + (double)d, 0.2F, 0.3F - boss.field_70170_p.field_73012_v.nextFloat() * 0.1F, 0.0F, 0.8F + boss.field_70170_p.field_73012_v.nextFloat() * 0.2F, 1.0F);
      }
   }
}
