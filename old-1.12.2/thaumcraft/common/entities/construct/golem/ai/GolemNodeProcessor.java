...
public class GolemNodeProcessor extends NodeProcessor {
   ...
   public PathPoint func_186318_b() {
      ...
      if (this.func_186322_e() && this.field_186326_b.func_70090_H()) {
         ...
         MutableBlockPos blockpos$mutableblockpos = new MutableBlockPos(MathHelper.func_76128_c(this.field_186326_b.field_70165_t), i, MathHelper.func_76128_c(this.field_186326_b.field_70161_v));
      ...
      PathNodeType pathnodetype1 = this.func_186331_a(this.field_186326_b, blockpos.func_177958_n(), i, blockpos.func_177952_p());
      ...
      return this.func_176159_a(blockpos.func_177958_n(), i, blockpos.func_177952_p());
   }
   ...
   public int func_186320_a(PathPoint[] p_186320_1_, PathPoint p_186320_2_, PathPoint p_186320_3_, float p_186320_4_) {
      ...
      if (flag && flag3) {
         pathpoint7 = this.func_186332_a(p_186320_2_.field_75839_a - 1, p_186320_2_.field_75837_b, p_186320_2_.field_75838_c - 1, j, d0, EnumFacing.NORTH);
      ...
      if (flag1 && flag3) {
         pathpoint7 = this.func_186332_a(p_186320_2_.field_75839_a - 1, p_186320_2_.field_75837_b, p_186320_2_.field_75838_c + 1, j, d0, EnumFacing.SOUTH);
         if (pathpoint7 != null && !pathpoint7.field_75842_i && pathpoint7.func_75829_a(p_186320_3_) < p_186320_4_) {
            p_186320_1_[i++] = pathpoint7;
         }
      }
         ...
         if (pathnodetype == PathNodeType.WALKABLE) {
            ...
            if (pathnodetype == PathNodeType.OPEN) {
               ...
               while(p_186332_2_ > 0 && pathnodetype == PathNodeType.OPEN) {
                  --p_186332_2_;
                  if (var18++ >= this.field_186326_b.func_82143_as()) {
                     return null;
                  }
   ...
   public PathNodeType func_186319_a(IBlockAccess p_186319_1_, int p_186319_2_, int p_186319_3_, int p_186319_4_, EntityLiving p_186319_5_, int p_186319_6_, int p_186319_7_, int p_186319_8_, boolean p_186319_9_, boolean p_186319_10_) {
         ...
         for(int j = p_186319_3_; j < p_186319_3_ + p_186319_7_; ++j) {
            for(int k = p_186319_4_; k < p_186319_4_ + p_186319_8_; ++k) {
               ...
               if (j > p_186319_3_ && pathnodetype1 != PathNodeType.OPEN) {
                  AxisAlignedBB axisalignedbb = new AxisAlignedBB((double)i - d0 + 0.5D, (double)p_186319_3_ + 0.001D, (double)k - d0 + 0.5D, (double)i + d0 + 0.5D, (double)((float)p_186319_3_ + p_186319_5_.field_70131_O), (double)k + d0 + 0.5D);
                  if (!p_186319_5_.field_70170_p.func_184143_b(axisalignedbb)) {
      ...
      if (enumset.contains(PathNodeType.FENCE)) {
         ...
         Iterator var22 = enumset.iterator();

         while(var22.hasNext()) {
            PathNodeType pathnodetype3 = (PathNodeType)var22.next();
   ...
   private PathNodeType func_186329_a(EntityLiving p_186329_1_, BlockPos p_186329_2_) {
      return this.func_186319_a(this.field_176169_a, p_186329_2_.func_177958_n(), p_186329_2_.func_177956_o(), p_186329_2_.func_177952_p(), p_186329_1_, this.field_176168_c, this.field_176165_d, this.field_176166_e, this.func_186324_d(), this.func_186323_c());
   }
   ...
   public static PathNodeType func_186330_a(IBlockAccess param0, int param1, int param2, int param3) {
      // $FF: Couldn't be decompiled
   }

   public PathNodeType func_186330_a(IBlockAccess param1, int param2, int param3, int param4) {
      // $FF: Couldn't be decompiled
   }
   ...
   private PathNodeType getPathNodeTypeRaw(IBlockAccess p_189553_1_, int p_189553_2_, int p_189553_3_, int p_189553_4_) {
      ...
      return material == Material.field_151579_a ? PathNodeType.OPEN : (block != Blocks.field_150415_aT && block != Blocks.field_180400_cw && block != Blocks.field_150392_bi ? (block == Blocks.field_150480_ab ? PathNodeType.DAMAGE_FIRE : (block == Blocks.field_150434_aF ? PathNodeType.DAMAGE_CACTUS : (block instanceof BlockDoor && material == Material.field_151575_d && !(Boolean)iblockstate.func_177229_b(BlockDoor.field_176519_b) ? PathNodeType.DOOR_WOOD_CLOSED : (block instanceof BlockDoor && material == Material.field_151573_f && !(Boolean)iblockstate.func_177229_b(BlockDoor.field_176519_b) ? PathNodeType.DOOR_IRON_CLOSED : (block instanceof BlockDoor && (Boolean)iblockstate.func_177229_b(BlockDoor.field_176519_b) ? PathNodeType.DOOR_OPEN : (block instanceof BlockRailBase ? PathNodeType.RAIL : (!(block instanceof BlockFence) && !(block instanceof BlockWall) && (!(block instanceof BlockFenceGate) || (Boolean)iblockstate.func_177229_b(BlockFenceGate.field_176466_a)) ? (material == Material.field_151586_h ? PathNodeType.WATER : (material == Material.field_151587_i ? PathNodeType.LAVA : (block.func_176205_b(p_189553_1_, blockpos) ? PathNodeType.OPEN : PathNodeType.BLOCKED))) : PathNodeType.FENCE))))))) : PathNodeType.TRAPDOOR);
   }
}
