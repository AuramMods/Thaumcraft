...
public class BlockRechargePedestal extends BlockTCDevice {
   public BlockRechargePedestal() {
      super(Material.field_151576_e, TileRechargePedestal.class);
   ...
   public boolean func_180639_a(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ) {
      if (world.field_72995_K) {
         ...
         if (tile != null && tile instanceof TileRechargePedestal) {
            ...
            if (ped.func_70301_a(0) == null && player.field_71071_by.func_70448_g() != null && player.field_71071_by.func_70448_g().func_77973_b() instanceof IRechargable) {
