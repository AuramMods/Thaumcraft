...
public class BlockStoneSlabTC extends BlockSlab implements IBlockTypes {
   public static final PropertyEnum VARIANT = PropertyEnum.func_177709_a("type", BlockStoneSlabTC.StoneType.class);
   ...
   public BlockStoneSlabTC() {
      ...
      this.func_180632_j(iblockstate.func_177226_a(VARIANT, BlockStoneSlabTC.StoneType.ARCANE));
   ...
   public Item func_180660_a(IBlockState state, Random rand, int fortune) {
      return Item.func_150898_a(BlocksTC.slabStone);
   }

   public Comparable<?> func_185674_a(ItemStack stack) {
      return BlockStoneSlabTC.StoneType.values()[stack.func_77960_j() & 7];
   }
   ...
   public void func_149666_a(Item itemIn, CreativeTabs tab, List list) {
      if (itemIn != Item.func_150898_a(BlocksTC.doubleSlabStone)) {
         BlockStoneSlabTC.StoneType[] aenumtype = BlockStoneSlabTC.StoneType.values();
         int i = aenumtype.length;

         for(int j = 0; j < i; ++j) {
            BlockStoneSlabTC.StoneType enumtype = aenumtype[j];
   ...
   public IBlockState func_176203_a(int meta) {
      IBlockState iblockstate = this.func_176223_P().func_177226_a(VARIANT, BlockStoneSlabTC.StoneType.values()[meta & 7]);
      if (!this.func_176552_j()) {
   ...
   public int func_176201_c(IBlockState state) {
      byte b0 = 0;
      int i = b0 | ((BlockStoneSlabTC.StoneType)state.func_177229_b(VARIANT)).ordinal();
   ...
   public int func_180651_a(IBlockState state) {
      return ((BlockStoneSlabTC.StoneType)state.func_177229_b(VARIANT)).ordinal();
   }
