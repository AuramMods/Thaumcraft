...
public class ModelNodeMagnet extends ModelBase {
   ...
   public ModelNodeMagnet() {
      ...
      this.magbase.func_78789_a(-1.0F, -1.0F, -4.0F, 2, 2, 1);
      this.magbase.func_78793_a(0.0F, -3.0F, 0.0F);
      this.magbase.func_78787_b(64, 32);
      this.setRotation(this.magbase, 0.0F, 0.0F, 0.0F);
      this.magcross = new ModelRenderer(this, 0, 14);
      this.magcross.func_78789_a(-3.0F, -1.0F, -6.0F, 6, 2, 2);
      this.magcross.func_78793_a(0.0F, -3.0F, 0.0F);
      this.magcross.func_78787_b(64, 32);
      this.setRotation(this.magcross, 0.0F, 0.0F, 0.0F);
      this.magr = new ModelRenderer(this, 0, 8);
      this.magr.func_78789_a(-4.0F, -1.0F, -9.0F, 2, 2, 4);
      this.magr.func_78793_a(0.0F, -3.0F, 0.0F);
      this.magr.func_78787_b(64, 32);
      this.magr.field_78809_i = true;
      this.setRotation(this.magr, 0.0F, 0.0F, 0.0F);
      this.magl = new ModelRenderer(this, 0, 8);
      this.magl.func_78789_a(2.0F, -1.0F, -9.0F, 2, 2, 4);
      this.magl.func_78793_a(0.0F, -3.0F, 0.0F);
      this.magl.func_78787_b(64, 32);
      this.magr.field_78809_i = true;
      ...
      this.base.func_78792_a(this.magcross);
      this.base.func_78792_a(this.magl);
      this.base.func_78792_a(this.magr);
   }
   ...
   public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float headpitch, float headyaw, float p_78087_6_, Entity entity) {
      ...
      this.magbase.field_78808_h = this.magcross.field_78808_h = this.magl.field_78808_h = this.magr.field_78808_h = ((EntityNodeMagnet)entity).rot / 57.295776F;
   }
}
