...
public class ModelFortressArmor extends ModelCustomArmor {
   ...
   public void func_78088_a(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
      ...
      int set = hasSet.containsKey(entity.func_145782_y()) ? (Integer)hasSet.get(entity.func_145782_y()) : -1;
      int mask = hasMask.containsKey(entity.func_145782_y()) ? (Integer)hasMask.get(entity.func_145782_y()) : -1;
