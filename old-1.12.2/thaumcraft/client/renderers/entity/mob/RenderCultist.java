...
public class RenderCultist extends RenderBiped<EntityCultist> {
   ...
   public void doRender(EntityCultist entity, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
      ...
      if (rit) {
         int val = (new Random((long)entity.func_145782_y())).nextInt(1000);
         ...
         GL11.glTranslated(0.0D, (double)bob, 0.0D);
      }
      ...
      if (rit) {
         ...
         this.drawFloatyLine(entity.field_70165_t, entity.field_70163_u + (double)(entity.func_70047_e() * 1.2F), entity.field_70161_v, (double)((EntityCultistCleric)entity).func_180486_cf().func_177958_n() + 0.5D, (double)((EntityCultistCleric)entity).func_180486_cf().func_177956_o() + 1.5D - (double)bob, (double)((EntityCultistCleric)entity).func_180486_cf().func_177952_p() + 0.5D, p_76986_9_, 1114129, -0.03F, (float)Math.min(((EntityCultistCleric)entity).field_70173_aa, 10) / 10.0F, 0.25F);
