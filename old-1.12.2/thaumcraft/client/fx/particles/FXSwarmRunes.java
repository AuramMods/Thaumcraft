...
public class FXSwarmRunes extends Particle {
   ...
   public void func_180434_a(VertexBuffer wr, Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
      ...
      float var8 = (float)this.particle / 64.0F;
      ...
      float var16 = 1.0F;
      float trans = (50.0F - (float)this.deathtimer) / 50.0F * 0.66F;
      int i = 240;
      int j = i >> 16 & '\uffff';
      int k = i & '\uffff';
   ...
   public void func_189213_a() {
      ...
      if (this.field_70546_d < 200 && this.target != null && !this.target.field_70128_L && (!(this.target instanceof EntityLivingBase) || ((EntityLivingBase)this.target).field_70725_aQ <= 0)) {
         ...
         if (v1.func_186679_c(this.target.field_70165_t, this.target.field_70163_u, this.target.field_70161_v) > (double)(this.target.field_70130_N * this.target.field_70130_N) && !hurt) {
            ...
            if (hurt && v1.func_186679_c(this.target.field_70165_t, this.target.field_70163_u, this.target.field_70161_v) < (double)(this.target.field_70130_N * this.target.field_70130_N)) {
