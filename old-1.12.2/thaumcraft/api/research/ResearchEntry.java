...
public class ResearchEntry {
   ...
   int displayRow;
   Object[] icons;
   ResearchEntry.EnumResearchMeta[] meta;
   ...
   public boolean hasMeta(ResearchEntry.EnumResearchMeta me) {
      return this.meta == null ? false : Arrays.asList(this.meta).contains(me);
   }
