...
public class CultistBootsItem extends ArmorItem implements WarpingGearItem {
    // TODO(port): Add legacy vis-discount behavior once vis cost systems are fully ported.
