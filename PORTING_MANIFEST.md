...
- `PORTING.md`
- `PORTING_MEMORY.md`
- Latest implementation checkpoint: see `PORTING.md` snapshot dated `2026-02-09` (includes spa mix-mode baseline plus legacy-shaped warp cadence with gear contribution and milestone-flag hooks).
