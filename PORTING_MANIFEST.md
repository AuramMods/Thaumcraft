...
- `PORTING.md`
- `PORTING_MEMORY.md`
- Latest implementation checkpoint: see `PORTING.md` snapshot dated `2026-02-09` (includes spa mix-mode baseline, legacy-shaped warp cadence with gear/milestone hooks, cultist/crimson warping armor baselines, and first vis-discount gear + arcane-workbench discount integration).
