...
- `PORTING.md`
- `PORTING_MEMORY.md`
- Latest implementation checkpoint: see `PORTING.md` snapshot dated `2026-02-09` (includes spa mix-mode baseline, legacy-shaped warp cadence with gear/milestone hooks, and dedicated cultist/crimson warping armor baselines).
